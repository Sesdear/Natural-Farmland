...
@Mod(NaturalFarmland.MODID)
public class NaturalFarmland {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "naturalfarmland";
    ...
    public NaturalFarmland(IEventBus modEventBus, ModContainer modContainer) {
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        LOGGER.info("NaturalFarmland by HLNikNiky Loaded!");
